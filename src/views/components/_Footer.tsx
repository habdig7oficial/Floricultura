...
function Footer() {
  let icons: icons[] = [
    {
      cname: "bi-github",
      link: "https://github.com/habdig7oficial/Floricultura.git",
    ...
    {
      cname: "bi-envelope-at-fill",
      link: "mailto:habdig7@gmail.com",
      path: "M2 2A2 2 0 0 0 .05 3.555L8 8.414l7.95-4.859A2 2 0 0 0 14 2H2Zm-2 9.8V4.698l5.803 3.546L0 11.801Zm6.761-2.97-6.57 4.026A2 2 0 0 0 2 14h6.256A4.493 4.493 0 0 1 8 12.5a4.49 4.49 0 0 1 1.606-3.446l-.367-.225L8 9.586l-1.239-.757ZM16 9.671V4.697l-5.803 3.546.338.208A4.482 4.482 0 0 1 12.5 8c1.414 0 2.675.652 3.5 1.671Z",
      path2:
  ...
  let components_icons: Array<JSX.Element> = [];
